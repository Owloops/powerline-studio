...
<template>
	<div class="flex flex-col gap-1.5">
		...
		<div class="relative">
			...
			>
				<div
					v-for="(_, colIdx) in columns"
					:key="colIdx"
					class="border-r border-dashed border-border/15"
					:class="colIdx === columns.length - 1 ? 'border-r-0' : ''"
				/>
			</div>

			<!-- Actual grid rows (z-10 to render above guideline overlay) -->
