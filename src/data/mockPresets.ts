...
export const MOCK_DATA_PRESETS: PresetMeta[] = [
	{
		id: 'default',
		name: 'Default',
		description: 'Normal active session with moderate values',
		factory: createDefaultPreset,
	},
	{
		id: 'minimal',
		name: 'Minimal Session',
		description: 'Fresh start, almost no usage, clean git',
		factory: createMinimalPreset,
	},
	{
		id: 'heavy',
		name: 'Heavy Session',
		description: 'Deep into work, high cost, high context, many messages',
		factory: createHeavyPreset,
	},
	{
		id: 'rate-limited',
		name: 'Rate Limited',
		description: 'Approaching or hitting rate limits',
		factory: createRateLimitedPreset,
	},
	{
		id: 'large-context',
		name: 'Large Context',
		description: 'Near context window capacity',
		factory: createLargeContextPreset,
	},
	{
		id: 'git-merge-conflict',
		name: 'Git Merge Conflict',
		description: 'Mid-merge with conflicts and staged/unstaged files',
		factory: createGitMergeConflictPreset,
	},
	{
		id: 'long-running',
		name: 'Long Running',
		description: 'Hours-long session with accumulated cost and metrics',
